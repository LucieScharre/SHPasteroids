...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 29 12:07:36 2021
...
# read in list of survey plates
# if plate no of catalog is contained in this list 
survey_plates = []
with open('ESO survey plate numbers.txt', 'r') as f:
    for line in f:
        survey_plates.append(line[0:4])



with open('ESO catalog.txt', 'r') as f:
    for line in f:
        ...
        if str(line[3:7]) in survey_plates:
                    #rint(line)
...
with open('sentry 2.txt', 'r') as f:
    for line in f:
        tokens = line.split('   ')
        object_ids.append(str(tokens[0]))
        Palermo.append(str(tokens[1]))"""
        
"""
object_ids = []
with open('MPC Dangerous.txt', 'r') as f:
    for line in f:
        
        #tokens = line.split('   ')
        #tokens = line.split(',')
        object_ids.append(line[27:37])"""
object_ids = []
sentry_objects = []
ESA_objects = []
MPC_objects = []    
...
object_ids = ['2016 NL56', '2006 CD', '2010 MZ112', '2017 WF30', '2010 VR139']
object_ids = ['2016 FG60', '2003 EG16', '2020 XR', '2002 CU11', '2014 SP142', '2008 ER7', '1998 MZ', '2001 XU30', '2020 BC6', '2000 YG29', '1998 DV9', '2003 YT1', '1998 SS49', '2002 SY50', '2012 BJ86', '1937 UB', '2005 UL5', '2005 NZ6', '2004 DV24', '2017 NM6', '1989 UP', '1989 AC', '2011 CT4', '2014 JO25', '2010 DM56', '2012 LR1', '2003 UV11', '2009 DM45', '2008 XQ2', '2015 RP82', '2000 RS11', '2008 CS1', '2017 KN34', '2016 CL264', '2019 CE4', '2008 WZ13', '2006 VV2', '2015 RH2', '2002 UK11', '2014 WG365', '1998 QP', '2012 QG42', '2006 KV89', '2015 KH157', '2012 XD112', '2013 QU1', '2007 HA', '2004 LJ1', '2005 XJ8', '2001 HA4', '2006 VC', '2013 US3', '2011 QD48', '1998 SL36', '2004 UV1', '2004 TB18', '2010 TX168', '2009 VZ', '2013 BK18', '2015 JD1', '2002 HK12', '2014 YY8', '6743 P-L', '2014 YW34', '2006 CJ', '2003 NW1', '2015 HB10', '2003 ED50', '1990 MU', '2012 MJ6', '2016 FC15', '2003 CR1', '2016 QJ44', '2013 QK48', '2008 UZ94', '2004 TP1', '2002 QQ40', '2015 FQ117', '2013 GY7', '2017 UY5', '2001 XU10', '2007 DS84', '2006 SX217', '2020 XD5', '2003 AA3', '2020 VZ5', '2002 GO5', '2010 BK2', '2020 QF6', '2016 CC30', '2004 RF84', '2020 RH7', '2015 TY237', '2004 VC', '2019 FH', '2001 LD', '1998 UT18', '1982 XB', '2016 PQ39', '2015 FT118', '2005 RC34', '2010 TP54', '2005 EY95', '2009 LW2', '2017 HY50', '2009 OG', '2004 XK50', '2017 ED4', '2011 KQ12', '2007 SJ', '2000 CM33', '2004 VB', '1989 DA', '2009 RZ3', '2003 VE1', '2010 SH13', '2005 PJ2', '2019 GT2', '1981 ET3', '2013 JM7', '2018 BA7', '2005 EW169', '2015 UK52', '2017 WG2', '2010 TV149', '2014 OY1', '2000 KW43', '2020 KG6', '2016 CJ195', '2007 TR24', '1993 BX3', '2018 XR', '2019 CT1', '2007 CS26', '2018 LC3', '2003 UX5']
...
for celest_object in object_ids:
    ...
    for j in range(len(batches)-1):
        ...
        if celest_object == "499" or "Ceres" or 'Vesta':  #mars needs id type specified
            ...
            id_type = "smallbody"
        #obj = Horizons(id=celest_object,id_type=id_type, location='260', epochs=plates_MJD[batches[j]:batches[j+1]])

        eph = Horizons(id=celest_object, id_type=id_type, location='809', epochs=plates_MJD[batches[j]:batches[j+1]]).ephemerides(quantities='1,3,9,38',refsystem="B1950")
